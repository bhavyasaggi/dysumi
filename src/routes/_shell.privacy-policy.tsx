		...
		<Container py="lg">
			<Typography>
				...
				<p>
					...
					<span style={{ color: "#8351f9" }}>[Company Name]</span> (doing
					business as{" "}
				...
				<ul>
					<li>
						...
						<span style={{ color: "#8351f9" }}>[Website URL]</span>, or any
						website of ours that links to this privacy notice
					</li>
					<li>
						<span style={{ color: "#8351f9" }}>
							[Download and use our application(s), such as our mobile
							application — [Mobile App Name], our Facebook application —
							[Facebook App Name], or any other application of ours that links
				...
				<p>
					...
					<span style={{ color: "#8351f9" }}>[Company Name]</span> and the
				...
				<p>
					...
					available here:{" "}
					<span style={{ color: "#8351f9" }}>[DSAR Form URL]</span>, or by
				...
				<p>
					...
					<span style={{ color: "#8351f9" }}>
						[We do not process sensitive information. / When necessary, with
						your consent or as otherwise permitted by applicable law, we process
				...
				<p>
					...
					stored by <span style={{ color: "#8351f9" }}>[Vendor Name]</span>. You
				...
				<ul>
					...
					<li>
						...
						<span style={{ color: "#8351f9" }}>
							...
							camera, own, and other features. If you wish to change our access
				...
				<ul>
					...
					<li>
						...
						For more information, see “<em>WHAT ARE YOUR PRIVACY RIGHTS?</em>”
						below).
					</li>
					<li>
				...
				<ul>
					...
					<li>
						...
						section titled “<em>HOW DO WE PROCESS YOUR INFORMATION?</em>”. [We
						obtain and store on your device (‘cache’) your location for{" "}
						<span style={{ color: "#8351f9" }}>[#]</span> months. You may revoke
						...
						Kingdom, please take a look at our Cookie Notice, which can be found
						at this link:{" "}
						<span style={{ color: "#8351f9" }}>[Cookie Notice URL]</span>.
					</li>
					<li>
				...
				<p>
					The Services,{" "}
					<span style={{ color: "#8351f9" }}>[including our offer wall]</span>,
				...
				<p>
					...
					data protection laws and regulations. Our Data Processing Agreements
					that include Standard Contractual Clauses are available here:{" "}
					<span style={{ color: "#8351f9" }}>
						[Standard Contractual Clauses URL]
					</span>
				...
				<p>
					These include a set of Binding Corporate Rules (“BCRs”) established
					and implemented by{" "}
					<span style={{ color: "#8351f9" }}>[Company Name]</span>. Our BCRs
					have been recognized by EEA and UK data protection authorities as
					providing an adequate level of protection to the personal information
					we process internationally. You can find a copy of our BCRs here:{" "}
				...
				<p>
					<span style={{ color: "#8351f9" }}>[Company Name]</span> and the
					following entities and subsidiaries:{" "}
					<span style={{ color: "#8351f9" }}>
						[List of Entities/Subsidiaries]
					</span>{" "}
					comply with the <span style={{ color: "#8351f9" }}>[EU-US]</span> and{" "}
					<span style={{ color: "#8351f9" }}>[Swiss-US]</span> Privacy Shield
					Framework<span style={{ color: "#8351f9" }}>[s]</span> as set forth by
					the US Department of Commerce regarding the collection, use, and
					retention of personal information transferred from{" "}
					...
					States. Although Privacy Shield is no longer considered a valid
					transfer mechanism for the purposes of{" "}
					<span style={{ color: "#8351f9" }}>[EU]</span> and{" "}
					<span style={{ color: "#8351f9" }}>[Swiss]</span> data protection law,
					in light of the judgment of the Court of Justice of the European Union
					in Case C-311/18 and opinion of the Federal Data Protection and
					Information Commissioner of Switzerland dated 8 September 2020,{" "}
					<span style={{ color: "#8351f9" }}>[Company Name]</span> will continue
					to comply with the principles of the{" "}
					<span style={{ color: "#8351f9" }}>[EU-US]</span> and{" "}
					<span style={{ color: "#8351f9" }}>[Swiss-US]</span> Privacy Shield
					Framework<span style={{ color: "#8351f9" }}>[s]</span>. To learn more
					about the Privacy Shield program, please visit{" "}
					<a
					...
					<span style={{ color: "#8351f9" }}>
						[Privacy Shield Certification URL]
					</span>
					.
				</p>
				<p>
					<span style={{ color: "#8351f9" }}>[Company Name]</span> adheres to
					and complies with the Privacy Shield Principles when processing
					personal information from{" "}
					<span style={{ color: "#8351f9" }}>[the EU]</span>,{" "}
					<span style={{ color: "#8351f9" }}>[UK]</span>, or{" "}
					<span style={{ color: "#8351f9" }}>[Switzerland]</span>. If we have
					received your personal information in the United States and
					subsequently transfer that information to a third party acting as our
					agent, and such third party agent processes your personal information
					in a manner inconsistent with the Privacy Shield Principles, we will
					remain liable unless we can prove we are not responsible for the event
				...
				<p>
					...
					<span style={{ color: "#8351f9" }}>[s]</span>,{" "}
					<span style={{ color: "#8351f9" }}>[Company Name]</span> is subject to
					the investigatory and enforcement powers of the US Federal Trade
				...
				<p>
					...
					<span style={{ color: "#8351f9" }}>[Company Name]</span>’s Privacy
					Shield certification, please write to us at the contact details below.
					We commit to resolving any complaints or disputes about our collection
					and use of your personal information under the Privacy Shield.{" "}
					<span style={{ color: "#8351f9" }}>
						[However, if you have an unresolved complaint in connection with our
						certification, we commit to cooperating with the panel established
						by [the EU data protection authorities (DPAs)], [the UK Information
						Commissioner], and [the Swiss Federal Data Protection and
						...
						. / However, if you have an unresolved complaint in connection with
						our certification, you may contact our independent dispute
						resolution provider based in the [EU/United States], [Dispute
				...
				<p>
					...
					redress from the Privacy Shield Panel, a binding arbitration
					mechanism.
				</p>
				<p>
					Please be sure to review the following sections of this Privacy Notice
					for additional details relevant to{" "}
					<span style={{ color: "#8351f9" }}>[Company Name]</span>’s
					participation in the <span style={{ color: "#8351f9" }}>[EU-US]</span>{" "}
					and <span style={{ color: "#8351f9" }}>[Swiss-US]</span> Privacy
					Shield:
				</p>
				<ul>
					<li>
						<em>WHAT INFORMATION DO WE COLLECT?</em> To learn more about the
					...
					<li>
						<em>WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</em>{" "}
						To learn more about the type or identity of third parties to which{" "}
						<em>
							<span style={{ color: "#8351f9" }}>[Company Name]</span>
						</em>{" "}
					...
					<li>
						<em>WHAT ARE YOUR PRIVACY RIGHTS?</em> To learn more about the right
				...
				<p>
					...
					<span style={{ color: "#8351f9" }}>
						...
						months past the termination of the user’s account / [#] months past
						the start of the idle period of the user’s account / other]
					</span>
					.
				</p>
				<p>
				...
				<p>
					...
					send, <span style={{ color: "#8351f9" }}>[Other]</span> or by
					contacting us using the details provided in the section “
					<em>HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</em>” below. You will
				...
				<ul>
					<li>
						Category A –{" "}
						<span style={{ color: "#8351f9" }}>[Retention Period]</span>
					</li>
					<li>
						Category B –{" "}
						<span style={{ color: "#8351f9" }}>[Retention Period]</span>
				...
				<p>
					<span style={{ color: "#8351f9" }}>[Company Name]</span> collects and
				...
				<ul>
					...
					<li>
						...
						<span style={{ color: "#8351f9" }}>[Social Media Plugins]</span>. We
						use social media features, such as a “Like” button, and widgets,
						such as a “Share” button in our Services. Such features may process
						your Internet Protocol (IP) address and track which page you are
						visiting on our website. We may place a cookie to enable the feature
						to work correctly. If you are logged in on a certain social media
						platform and you interact with a widget or button belonging to that
						social media platform, this information may be recorded to your
						profile of such social media platform. To avoid this, you should log
						out from that social media platform before accessing or using the
						Services. Social media features and widgets may be hosted by a third
						party or hosted directly on our Services. Your interactions with
						these features are governed by the privacy notices of the companies
						that provide them. By clicking on one of these buttons, you agree to
						the use of this plugin and consequently the transfer of personal
						information to the corresponding social media service. We have no
						control over the essence and extent of these transmitted data or
				...
				<p>
					...
					toll-free at <span style={{ color: "#8351f9" }}>[Phone Number]</span>,
					by visiting{" "}
				...
				<p>
					<span style={{ color: "#8351f9" }}>[Company Name]</span> has disclosed
					the following categories of personal information to third parties for
				...
				<ul>
					...
					<li>
						Category H. Audio, electronic, visual, and similar information, such
						as images and audio, video, or call recordings created in connection
						with our business activities.
					</li>
					<li>
					...
					<li>
						...
						information, drivers’ licenses, health data, precise geolocation,
						racial or ethnic origin, religious or philosophical beliefs, and sex
				...
				<p>
					<span style={{ color: "#8351f9" }}>
						[[Company Name] has not sold or shared any personal information to
						third parties for a business or commercial purpose in the preceding
						twelve (12) months. / [Company Name] has sold or shared the
						following categories of personal information to third parties in the
				...
				<p>
					<span style={{ color: "#8351f9" }}>
						...
						personal Information, please email [Email Address] or visit: [DSAR
						Form URL].
					</span>
					]
				</p>
					...
					<li>
						<ul>
							<li>
								<ul>
									<li>
										a good-faith estimate of the value of the consumer’s data
										that forms the basis for offering the financial incentive or
										price or service difference; and
									</li>
									<li>
										a description of the method the business used to calculate
				...
				<p>
					...
					<span style={{ color: "#8351f9" }}>[Email Address]</span>, by calling
					us toll-free at{" "}
					<span style={{ color: "#8351f9" }}>[Phone Number]</span>, by visiting{" "}
					<span style={{ color: "#8351f9" }}>[Contact Form URL]</span>, or by
					referring to the contact details at the bottom of this document.
				</p>
				<p>
				...
				<p>
					Our metrics for all CCPA requests received for the previous calendar
				...
				<p>
					...
					<span style={{ color: "#8351f9" }}>[Company Name]</span> and our
					Services. To find out more, please visit the following sections above:
				</p>
				<ul>
				...
				<ul>
					...
					<li>
						...
						similarly significant effects ([“profiling”/’profiling’])
					</li>
				</ul>
				<p>
					<span style={{ color: "#8351f9" }}>
						[[Company Name] has not sold any personal data to third parties for
						business or commercial purposes. [Company Name] will not sell
						personal data in the future belonging to website visitors, users,
						and other consumers. / [Company Name] sells personal data to third
						parties or processes personal data for targeted advertising. Please
						see the following section to find out how you can opt out from
						further selling or sharing of your personal data for targeted
						advertising or profiling purposes.]
					</span>
				</p>
				<p>
					<span>Exercise your rights provided under the Virginia CDPA</span>
				</p>
				<p>
					More information about our data collection and sharing practices can
					be found in this privacy notice and our Cookie Notice:{" "}
				...
				<p>
					...
					<span style={{ color: "#8351f9" }}>[Email Address]</span>. Within
					...
					is denied, you may contact the Attorney General to{" "}
					<a
				...
				<p>
					...
					<span style={{ color: "#8351f9" }}>[Phone Number]</span>, or by post
					to:
				</p>
				<p>
					<span style={{ color: "#8351f9" }}>[Company Name]</span>
				...
				<p>
					...
					<span style={{ color: "#8351f9" }}>[EEA Representative Name]</span> to
					be its representative in the EEA. You can contact them directly
					regarding the processing of your information by{" "}
					<span style={{ color: "#8351f9" }}>[Company Name]</span>, by email at{" "}
					<span style={{ color: "#8351f9" }}>[Email Address]</span>, by visiting{" "}
					<span style={{ color: "#8351f9" }}>[EEA Representative URL]</span>, by
					phone at <span style={{ color: "#8351f9" }}>[Phone Number]</span>, or
					by post to:
				</p>
				<p>
					<span style={{ color: "#8351f9" }}>[Street Address]</span>
				...
				<p>
					...
					<span style={{ color: "#8351f9" }}>[Company Name]</span>.{" "}
					<span style={{ color: "#8351f9" }}>[Company Name]</span> has appointed{" "}
					<span style={{ color: "#8351f9" }}>[UK Representative Name]</span> to
					be its representative in the UK. You can contact them directly
					regarding the processing of your information by{" "}
					<span style={{ color: "#8351f9" }}>[Company Name]</span>, by email at{" "}
					<span style={{ color: "#8351f9" }}>[Email Address]</span>, by visiting{" "}
					<span style={{ color: "#8351f9" }}>[UK Representative URL]</span>, by
					phone at <span style={{ color: "#8351f9" }}>[Phone Number]</span>, or
					by post to:
				</p>
				<p>
				...
				<p>
					...
					visit: <span style={{ color: "#8351f9" }}>[DSAR Form URL]</span>.
				</p>
			</Typography>
		</Container>
	);
