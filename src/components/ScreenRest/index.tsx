...
import ViewerRest from "@/lib/ui/ViewerRest";

export default function ScreenRest() {
	...
	if (!source) {
		return (
			<Center py="xl" px="sm" h="100%">
				<Text c="dimmed">No HTTP content to display</Text>
			</Center>
		);
	}

	return <ViewerRest key={activeFile?.path} source={source} />;
}
